...
public partial class AirLinesAnomicContext : DbContext
{
    ...
    public virtual DbSet<FlightReport> FlightReports { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<FlightReport>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__FlightRe__3214EC2736F085C4");
            ...
            entity.HasOne(d => d.CabinType).WithMany(p => p.FlightReports)
                .HasForeignKey(d => d.CabinTypeId)
                .HasConstraintName("FK_FlightReports_CabinTypeID");

            entity.HasOne(d => d.DestinationAirport).WithMany(p => p.FlightReports)
                .HasForeignKey(d => d.DestinationAirportId)
                .HasConstraintName("FK_FlightReports_DestinationAirportID");
        });
